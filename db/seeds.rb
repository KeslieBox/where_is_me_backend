...
Politic.create([{name: 'BLM'}, {name: 'BTLM'}, {name: 'ACAB'}, {name: 'No SWERFS'}, {name: 'No TERFS'}, {name: 'feminist'}, {name: 'communist'}, {name: 'socialist'}, {name: 'leftist'}, {name: 'anarchist'}, {name: 'abolitionist'}, {name: 'liberal'}, {name: 'moderate'}, {name: 'democrat'}])
